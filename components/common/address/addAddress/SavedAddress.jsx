    ...
    return (
        <TouchableOpacity style={{ display: "flex", flexDirection: "row", alignItems: "center", gap: wp(4), borderWidth: wp(0.1), borderRadius: wp(3), borderColor: "#202020", padding: wp(3), marginVertical: 10 }}>
            ...
            <View>
                ...
                <Text style={{ fontFamily: "OpenSans-Regular", color: "#000000", lineHeight: hp(2), fontSize: hp(1.8), letterSpacing: wp(0.2), textTransform: "capitalize" }}>{`${item?.area} ${item.state}`}</Text>
            </View>
