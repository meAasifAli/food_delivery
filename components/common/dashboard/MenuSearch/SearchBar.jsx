        ...
        <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : "height"}>
            <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
                <View style={{ position: "relative", }}>
                    ...
                    <TextInput value={searchQuery} onChangeText={(text) => setSearchQuery(text)} style={{ backgroundColor: "#000", color: "#FA4A0C", paddingLeft: 35, borderRadius: 10, fontFamily: "OpenSans-Regular" }} placeholderTextColor={"#FA4A0C"} placeholder={`Search in ${restaurantName}`} />
