    ...
    return (
        <View style={{ marginTop: 20 }}>
            <View style={{ marginLeft: "2%" }}>
                <Typography title={"Offers for you"} ff={"OpenSans-Regular"} lh={32} size={24} fw={400} color={"#000"} />
            </View>
            {
                offers?.length > 0 && offers?.map((offer, id) => {
                    return (
                        <View key={id} style={{ marginTop: 10 }}>
                            <View style={{ width: "95%", height: hp(15), marginHorizontal: "auto", borderTopEndRadius: 10, borderTopStartRadius: 10, borderStyle: "dashed", borderColor: "#D6D6D6", borderWidth: 1, padding: hp(4) }}>
