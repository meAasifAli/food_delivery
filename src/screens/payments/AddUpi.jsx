    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.brandsWrapper}>
                ...
                <View>
                    <Image style={{ width: 40, height: 40, objectFit: "contain" }} source={require("../../assets/images/phonepe_logo.png")} />
                </View>
                <View>
                    <Image style={{ width: 40, height: 40, objectFit: "cover" }} source={require("../../assets/images/amazon_pay.png")} />
                </View>
            </View>
